...
abstract class CefBrowser_N extends CefNativeAdapter implements CefBrowser {
     ...
     */
    protected void createBrowser(CefClientHandler clientHandler, long windowHandle, String url, boolean transparent, Component canvas, CefRequestContext context) {
     ...
     */
    protected final void createDevTools(CefBrowser parent, CefClientHandler clientHandler, long windowHandle, boolean transparent, Component canvas, Point inspectAt) {
        if (getNativeRef("CefBrowser") == 0 && !isPending_) {
            try {
                isPending_ = N_CreateDevTools(parent, clientHandler, windowHandle, transparent, canvas, inspectAt);
            } catch (UnsatisfiedLinkError err) {
                err.printStackTrace();
            }
        }
    ...
    private final native boolean N_CreateBrowser(CefClientHandler clientHandler, long windowHandle, String url, boolean transparent, Component canvas, CefRequestContext context);

    private final native boolean N_CreateDevTools(CefBrowser parent, CefClientHandler clientHandler, long windowHandle, boolean transparent, Component canvas, Point inspectAt);
