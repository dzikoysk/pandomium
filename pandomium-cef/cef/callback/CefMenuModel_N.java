...
class CefMenuModel_N extends CefNativeAdapter implements CefMenuModel {
    ...
    private final native boolean N_SetAccelerator(int command_id, int key_code, boolean shift_pressed, boolean ctrl_pressed, boolean alt_pressed);

    private final native boolean N_SetAcceleratorAt(int index, int key_code, boolean shift_pressed, boolean ctrl_pressed, boolean alt_pressed);
    ...
    private final native boolean N_GetAccelerator(int command_id, IntRef key_code, BoolRef shift_pressed, BoolRef ctrl_pressed, BoolRef alt_pressed);

    private final native boolean N_GetAcceleratorAt(int index, IntRef key_code, BoolRef shift_pressed, BoolRef ctrl_pressed, BoolRef alt_pressed);
}
